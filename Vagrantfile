...
#     maxscale1.vm.box = "ubuntu/xenial64"
#     maxscale1.vm.hostname = 'maxscale1'
#     maxscale1.vm.box_url = "ubuntu/xenial64"
...
#     maxscale2.vm.box = "ubuntu/xenial64"
#     maxscale2.vm.hostname = 'maxscale2'
#     maxscale2.vm.box_url = "ubuntu/xenial64"
...
#  end
   config.vm.define "db1" do |db1|
    ...
    db1.vm.hostname = 'db1'
    db1.vm.box_url = "ubuntu/xenial64"
  ...
  config.vm.provision "shell" do |s|
   ...
   config.vm.define "db2" do |db2|
    ...
    db2.vm.hostname = 'db2'
    db2.vm.box_url = "ubuntu/xenial64"
  ...
  config.vm.define "db3" do |db3|
    db3.vm.box = "ubuntu/xenial64"
    db3.vm.hostname = 'db3'
    db3.vm.box_url = "ubuntu/xenial64"
